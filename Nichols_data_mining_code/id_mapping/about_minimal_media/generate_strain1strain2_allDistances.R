...
setwd("D:/Dropbox/HuLab/microbial_phenotype_data_mining/Nichols_Data_mining/")
...
save(mi_all,file="./mi_all_noMinimalMedia.RData")
load("./mi_all_noMinimalMedia.RData")
...
start.time = Sys.time()
mi_ternary=( 1- infotheo::mutinformation(t(dat) %>% as.data.frame) %>% infotheo::natstobits() ) %>% melt_dist 
end.time = Sys.time()
...
strain1strain2_allDistances_noMinimalMedia=strain1strain2_allDistances
save(strain1strain2_allDistances_noMinimalMedia,file="Data/strain1strain2_allDistances_noMinimalMedia.RData")
