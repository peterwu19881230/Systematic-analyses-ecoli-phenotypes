...
pacman::p_load(tidyverse,pbapply,BiocManager,readxl,factoextra,pheatmap,ComplexHeatmap,XML,reshape2,googlesheets,googledrive,
               circlize,ape,dendextend,sqldf,RMySQL,AnnotationHub,infotheo,stringi,purrr,ggfortify,ggplotify,cowplot,gridGraphics,gridExtra,grid) #Note ggplot2 is loaded when tidyverse or factoextra is loaded 
